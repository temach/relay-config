...
namespace timerelay_server
{
    ...
    public class ConnectionClass
    {
        ...
        public DeviceOptions DevOpt = new DeviceOptions();
        public CtrlProgramOptions ProgsOpt = new CtrlProgramOptions();
        ...
        public void LetLinksOnOptions(DeviceOptions Dev1, CtrlProgramOptions Prog1)
        {
            this.ResetVars();
        }
        ...
        public void ResetVars()
        {
            ...
            this.DevOpt = deviceOptions;
            this.ProgsOpt = programOptions;
        }
        ...
        public int ReadData(byte[] newDataByte, ref DeviceOptions DeviceOptions, ref CtrlProgramOptions CtrlProgramsOptions)
        {
            int num = 0;
            this.BytesCount = 0;
                    ...
                    for (int index = 1; index <= 31; ++index)
                    {
                        ...
                        switch (this.ByteInReadBlock)
                        {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                this.ProgsOpt[this.NumProgOfData].RelayTimeMode = (CtrlProgramOptions.RelayTimeModeType)newDataByte[index];
                                this.CountLoops = 1;
                                break;
                            case 7:
