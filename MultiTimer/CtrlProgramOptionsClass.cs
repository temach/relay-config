// NoAuthor
// Type: MultiTimerWinForms.CtrlProgramOptionsClass
...
namespace MultiTimerWinForms
{
  ...
  public class CtrlProgramOptionsClass : CollectionBase, ICloneable
  {
    ...
    public CtrlProgramOptionsClass.RelayTimeModeType RelayTimeMode;
    public bool AllowDaysoffs;
    public bool AllowHolidays;
    public bool AllowCyclicity;
    public CtrlProgramOptionsClass.AdjTime RI_BeforeDelay;
    public CtrlProgramOptionsClass.AdjTime RI_OnDelay;
    public CtrlProgramOptionsClass.AdjTime RI_OffDelay;
    public CtrlProgramOptionsClass.AdjTime RS_Delay;
    public bool RV_OnOff;
    public int RV_Umin;
    public int RV_Uminhyst;
    public int RV_Umax;
    public int RV_Umaxhyst;
    public CtrlProgramOptionsClass.AdjTime RV_DelayUmin;
    public CtrlProgramOptionsClass.AdjTime RV_DelayUnorm;
    public CtrlProgramOptionsClass.AdjTime RV_DelayUmax;
    public bool RF_OnOff;
    public int RF_Lpor;
    public int RF_Lporhyst;
    public CtrlProgramOptionsClass.AdjTime RF_DelayLmin;
    public CtrlProgramOptionsClass.AdjTime RF_DelayLmax;
    ...
    public CtrlProgramOptionsClass this[int ProgramIndex]
    {
      get
      {
        return (CtrlProgramOptionsClass) this.List[ProgramIndex];
      }
      set
      {
    ...
    public object Clone()
    {
      CtrlProgramOptionsClass programOptionsClass = (CtrlProgramOptionsClass) this.MemberwiseClone();
    ...
    {
      this.RelayTimeMode = CtrlProgramOptionsClass.RelayTimeModeType.R_T_M_OFF;
    ...
    public void Test1()
    {
      foreach (CtrlProgramOptionsClass programOptionsClass in (CollectionBase) this)
